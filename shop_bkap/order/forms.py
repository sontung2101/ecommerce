...
class oderForm(forms.ModelForm):
    class Meta:
        ...
        fields = "__all__"
        widgets = {
            'name': forms.TextInput(attrs={'value':'{{user.username}}','class': 'size13 bo4 m-b-12 sizefull s-text7 p-l-15 p-r-15', 'placeholder': 'Name','style':'border:1px solid #e6e6e6 !important ;max-width:500px;height :50px;padding: 7px ; font-size :20px '}),
